<?php 
$qr_view ="SELECT nama_tugas,tgl_mengumpulkan,isi_tugas,lampiran FROM tb_pengumpulan WHERE id_tugas='$_GET[hr_id]' AND id='$_GET[id]'";
...
list($nama_tugas,$tgl_mengumpulkan,$isi_tugas,$lampiran) =  mysqli_fetch_row($tampil);
...
<h4>Tanggal Pengumpulan : </h4>
    <?= tgl_indonesia($tgl_mengumpulkan); ?>
</div>
