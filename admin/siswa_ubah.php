...
?>
<div class="kembali">
        <a href="?module=dfrsiswa">&#10094; Kembali</a>
</div>
    ...
    <form method="post" >
        ...
        if($username !== $ls_user){
            //cek username udah ada belum
            $qr_cek = "SELECT `username` FROM `tb_siswa` WHERE `username`='".$username."'";
     ...
     //---------------------------------------------------
	   ...
	   header('location:index.php?module=dfrsiswa');
        }
    ?>